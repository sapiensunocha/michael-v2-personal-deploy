...
import { FaBars, FaGripLinesVertical, FaThLarge } from "react-icons/fa";
...
import DisasterEmailAlterModal from "./emailAlertModal";
  ...
  return (
    <>
      <>
        ...
        <div className="flex w-[95%] items-center justify-between absolute left-1/2 transform -translate-x-1/2 my-10 z-10">
            ...
            <div className="hidden md:flex px-auto backdrop-blur-2xl bg-white/10 rounded-full shadow-xl">
              ...
              <Popover onOpenChange={() => setShowDot(false)}>
                ...
                <PopoverContent className="w-80">
                  <DisasterEmailAlterModal
                    onClose={handleCloseDisasterEmailAlterModal}
                  />
                </PopoverContent>
              </Popover>
            </div>
          ...
          <div className="flex items-center gap-4">
            ...
            />
             {/* Apps Icon */}
              <FaThLarge
                className="w-[35px] h-[35px]  p-2 text-red-700 bg-white cursor-pointer mt-3 hover:bg-gray-900 hover:text-white transition-colors"
        ...
        <AppsModal isOpen={isAppsModalOpen} onClose={setIsAppsModalOpen} />
        {isMobileMenuOpen && (
